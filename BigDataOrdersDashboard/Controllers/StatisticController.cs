...
namespace BigDataOrdersDashboard.Controllers
{
    public class StatisticController : Controller
    {
        ...
        public StatisticController(BigDataOrdersDbContext context)
        {
            _context = context;
        }
        public IActionResult Index()
        {
            ...
            ViewBag.AprilOrders = _context.Orders
    .FromSqlRaw("Select * From Orders Where OrderDate >= '2026-04-01' AND OrderDate < '2026-05-01'")
    .Count();

            ViewBag.Orders2026Count = _context.Orders.Where(x => x.OrderDate.Year == 2026).Count();
